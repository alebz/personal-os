...
export default function XPDesktop({ sections }: { sections: OSSection[] }) {
  ...
  const openReproductor = () => openWindow('radio', 'Reproductor de Windows Media', <RadioPlayer onClose={() => closeWindow('radio')} onMinimize={() => minimizeWindow('radio')} />, { w: 500, h: 420, bare: true, icon: 'wmp' })
