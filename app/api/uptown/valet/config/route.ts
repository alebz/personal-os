...
// POST /api/uptown/valet/config — upsert monthly valet configuration (num_weeks, price_per_point).
// Las semanas del valet son los sábados reales del mes (lib/valet) — week1_date se eliminó (nunca fue
// distinto del primer sábado). Provider payments and the Nu balance live in the Cuenta Nu ledger.
